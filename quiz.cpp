...
class Quiz {
public:
  Quiz() : score(0) { loadQuestions(); }

  void start() {
    cout << "Welcome to the Quiz! You have " << TIME_LIMIT
    ...
    cout << "\nQuiz finished! Your total score is: " << score << "/"
         << questions.size() * POINTS_PER_CORRECT_ANSWER << "\n";
  }
...
private:
  ...
  void loadQuestions() {
    ...
    questions.push_back({"Who wrote 'To Kill a Mockingbird'?",
                         {"A) Harper Lee", "B) J.K. Rowling",
